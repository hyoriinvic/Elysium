...
<body>
    ...
    <form>
        <section class="checkbox-container" id="body-img">
            ...
            <div>
                <input type="checkbox" id="sholder">
            ...
            <div>
                <input type="checkbox" id="stomach">
